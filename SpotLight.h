...
public:
	SpotLight();
	SpotLight(GLfloat red, GLfloat green, GLfloat blue, GLfloat aIntensity, GLfloat dIntensity, glm::vec3 position,glm::vec3 dir, GLfloat edge, GLfloat cons, GLfloat lin, GLfloat exp);
